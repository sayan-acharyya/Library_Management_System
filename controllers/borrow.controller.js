...
export const recordBorrowedBook = catchAsyncErrors(async (req, res, next) => {
    ...
    if (!book) {
        return next(new ErrorHandler("Book not fount", 404));
    }
    ...
    if (book.quantity === 0) {
        return next(new ErrorHandler("Book not available right now ", 400));
    }
...
export const getBorroowedBookedForAdmin = catchAsyncErrors(async (req, res, next) => {
